...
Public Class Form1
    ...
    Sub Load_controls()
        ...
        price.Text = " Price              : Kshs " & dr.Item("price").ToString
    ...
    Sub Get_grandTotal()
        Try
            ...
            Next
            lbl_overallTotal.Text = Format(CDec(grandtotal), "Kshs #,##0.00")
            lbl_GrandTotal.Text = Format(CDec(grandtotal), "Kshs #,##0.00")
    ...
    Private Sub btn_Pay_Click(sender As Object, e As EventArgs) Handles btn_Pay.Click
        ...
        If MsgBox("Are You Sure Order Conform ?", vbQuestion + vbYesNo) = vbYes Then
            ...
            ElseIf txt_BalanceAmount.Text < 0 Then
                MsgBox("Infinity Balance !" & vbNewLine & txt_receivedAmount.Text & " Kshs", MsgBoxStyle.Exclamation)
                Return
            Else
                Try
                    conn.Open()
